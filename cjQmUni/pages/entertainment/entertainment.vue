<template>
	<view>
		...
		<view class=""
			style="background-color: #dfdfdf; border: solid black 4rpx; margin: 0 auto; width: 80%; border-radius: 50rpx;">
			...
			<view v-for="(item, index) in sousuokuang" :key="index">
				<view class="article-item" @tap="handleToxiangqing(item.id)">
					...
					<view class="image-container">
						<image v-for="image in [item.urlOne, item.urlTwo, item.urlThree]" :src="image" mode="widthFix"
